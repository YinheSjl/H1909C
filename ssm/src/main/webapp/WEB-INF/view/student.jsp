...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="cid" id = "txt_search_cid">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_startTime" name="start" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间"id="txt_search_endTime" name="end" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="inStudent.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_student_btn">导入</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_student_btn").click(function(){
	    	$("#form_in").submit();
	    });
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({
	            ...
	            pageSize: 3,                       //每页的记录行数（*）
	            pageList: [3, 6, 9, 75, 100],    //可供选择的每页的行数（*）
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            cid: $("#txt_search_cid").val(),
	            start: $("#txt_search_startTime").val(),
	            end: $("#txt_search_endTime").val(),
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	res.data.forEach(function(student){
	    		    		xary.push(student.sname);
	    		    		yary.push({value: student.num, name:studnet.sname});
	    		    	});
	    		    		 var option = {
	    		    				    title: {
	    		    				        text: '设备类型分布图',
	    			...
	    			$('#modal_content_echarts').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_content_echarts").show();
	        });
